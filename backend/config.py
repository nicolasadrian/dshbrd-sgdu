...
WHITELISTS = {
    ...
    "etapa_proyecto": [
        "A.PEREZ", "AGUSDEMARCO", "ANTOVERA", "BELOCURESJ", "COIROL", "DBECERRACURITIMA", 
        "DGROC-OBRASTECNICA", "DIMASOM", "DNKAINSKY", "FORGIONEA", "GAILLURJP", "GARRIONDO", 
        "JOSEFINA.P", "M.SANCHEZ", "MARCE.TOSONI", "MARCETOSONI", "MARCETOSONI1", "MBRISA", 
        "MCANOGARAY", "MCARLUCCIO", "MGALLARDOC", "MSTIBERTI", "NLOPEZQUIROGA", "ROCABERTJ", 
        "SPUET", "TALAMOM", "VERA"
    ],
    "morfologia": [
...
BUZZERS_MAP = {
    ...
    "regularizacion": ['DGROC-OBRASDEMO', 'DGROC-OBRASTECNICA'],
