        ...
        with engine.connect() as conn:
            sql = """
                SELECT 
                    ...
                    ext.fecha_creacion as fecha_ing,
                    ...
                    (CURRENT_DATE - ext.fecha_creacion::date) as dias_en_gerencia
                FROM mv_ultimo_pase up
    ...
    if metric in ['STOCK_PROPIO', 'STOCK_SUBS', 'STOCK_TOTAL'] and not is_current_month:
        if metric == 'STOCK_PROPIO':
            sql = """
                ...
                SELECT 
                    ...
                    to_char(ext.fecha_creacion, 'YYYY-MM-DD HH24:MI:SS') AS "FECHA INGRESO",
                    ...
                    (CAST(:cut_off_date AS date) - CAST(ext.fecha_creacion AS date)) AS "DIAS EN GERENCIA",
        ...
        sql = """
            ...
            SELECT 
                ...
                (CURRENT_DATE - ext.fecha_creacion::date) AS "DIAS EN GERENCIA",
                up.destinatario_actual AS "ANALISTA",
                du.apellido_nombre AS "ANALISTA NOMBRE",
                ext.descripcion_trata AS "DESCRIPCION TRATA",
                ext.descripcion AS "DESCRIPCION",
