...
-- Trámite: Anulación de Propiedad Horizontal (MDUG0115C)
...
SELECT 
    ...
    'MDUG0115C' as "COD TRATA",
    'Anulación de Propiedad Horizontal' as "DETALLE TRATA",
