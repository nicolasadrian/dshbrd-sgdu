...
-- Trámite: Certificado de información catastral (MDUG1501H)
...
SELECT 
    ...
    'MDUG1501H' as "COD TRATA",
    'Certificado de información catastral' as "DETALLE TRATA",
