...
-- Trámite: Constitución de Estado Parcelario (MDUG0134N)
...
egresos_efectivos AS (
    ...
    WHERE g.acronimo IN ('IFGPA', 'FIPAR')
...
SELECT 
    ...
    'MDUG0134N' as "COD TRATA",
    'Constitución de Estado Parcelario' as "DETALLE TRATA",
