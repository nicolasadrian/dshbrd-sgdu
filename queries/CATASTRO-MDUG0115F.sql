...
-- Trámite: Plano de mensura de objeto territorial (MDUG0115F)
...
SELECT 
    ...
    'MDUG0115F' as "COD TRATA",
    'Plano de mensura de objeto territorial' as "DETALLE TRATA",
