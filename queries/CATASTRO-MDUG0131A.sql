...
-- Trámite: Plano de Propiedad Horizontal modif/compl (MDUG0131A)
...
SELECT 
    ...
    'MDUG0131A' as "COD TRATA",
    'Plano de Propiedad Horizontal modif/compl' as "DETALLE TRATA",
