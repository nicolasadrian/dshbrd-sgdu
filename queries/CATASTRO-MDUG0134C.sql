...
-- Trámite: Certificado de numeración domiciliaria (MDUG0134C)
...
SELECT 
    ...
    'MDUG0134C' as "COD TRATA",
    'Certificado de numeración domiciliaria' as "DETALLE TRATA",
