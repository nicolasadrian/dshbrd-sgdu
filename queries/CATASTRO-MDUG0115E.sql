...
-- Trámite: Rectificación de Plano de Mensura (MDUG0115E)
...
egresos_efectivos AS (
    ...
    WHERE g.acronimo IN ('IFMSC', 'IFMHC')
...
SELECT 
    ...
    'MDUG0115E' as "COD TRATA",
    'Rectificación de Plano de Mensura' as "DETALLE TRATA",
