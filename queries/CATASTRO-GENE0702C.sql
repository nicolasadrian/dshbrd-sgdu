...
-- Trámite: Mensura Regularización Urbana Dominial (GENE0702C)
...
SELECT 
    ...
    'GENE0702C' as "COD TRATA",
    'Mensura Regularización Urbana Dominial' as "DETALLE TRATA",
