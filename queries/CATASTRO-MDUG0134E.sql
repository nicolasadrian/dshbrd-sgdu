...
-- Trámite: Solicitud de Certificado de fijación de línea (MDUG0134E)
...
SELECT 
    ...
    'MDUG0134E' as "COD TRATA",
    'Solicitud de Certificado de fijación de línea' as "DETALLE TRATA",
