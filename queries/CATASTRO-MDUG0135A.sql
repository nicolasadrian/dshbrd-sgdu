...
-- Trámite: Solicitud de consideración a la DGROC (MDUG0135A)
...
egresos_efectivos AS (
    ...
    WHERE g.acronimo IN ('IFMHC', 'IFMMH', 'IFMAD', 'IFMSC', 'IFMOT', 'IFPCB', 'FIPAR')
...
SELECT 
    ...
    'MDUG0135A' as "COD TRATA",
    'Solicitud de consideración a la DGROC' as "DETALLE TRATA",
